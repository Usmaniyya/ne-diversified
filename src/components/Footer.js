...
const Footer = () => {
  return (
    <footer className="relative z-10 bg-secondary pt-16 pb-6 lg:pt-[80px] lg:pb-8 px-16 lg:px-24">
      <div className="container">
        <div className="flex justify-between flex-wrap -mx-4">
          <div className="w-full px-4 sm:w-2/3 lg:w-3/12">
            <div className="w-full mb-10">
              <h1 className="text-light text-2xl font-bold">
                <span className="text-dark">NE&nbsp;</span>Diversified
              </h1>

              <p className="flex items-center text-sm font-medium text-light">
          ...
          <LinkGroup header="Company">
            ...
            <NavLink link="/#" label="Policy" />
            <NavLink link="/#" label="Our Services" />
            <NavLink link="/#" label="Know Our Team" />
          </LinkGroup>
          <div className="w-full px-4 sm:w-1/2 lg:w-3/12">
            <div className="w-full mb-10">
              <h4 className="text-lg font-semibold mb-9 text-light">
                Follow us On
              </h4>
              <div className="flex items-center mb-6">
                <a
                  href="/#"
                  className="mr-3 flex h-8 w-8 items-center justify-center rounded-full border border-[#E5E5E5] text-light hover:border-dark hover:bg-dark hover:text-light sm:mr-4 lg:mr-3 xl:mr-4"
                >
                  <svg
                    width={8}
                    height={16}
              ...
              <p className="text-base text-light">
                {' '}
                © {new Date().getFullYear()} NE Diversified{' '}
              </p>
            </div>
          </div>
        </div>
...
const LinkGroup = ({ children, header }) => {
  return (
    <div className="w-full px-4 sm:w-1/2 lg:w-2/12">
      <div className="w-full mb-10">
        <h4 className="text-lg font-semibold mb-9 text-light"> {header} </h4>
        <ul>{children}</ul>
      </div>
    </div>
  )
  ...
  return (
    <div>
      <li>
        <a
          href={link}
          className={`inline-block mb-2 text-base leading-loose text-light hover:text-dark`}
        >
          {label}
        </a>
      </li>
